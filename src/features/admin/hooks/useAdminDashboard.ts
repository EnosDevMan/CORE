...
import { LayoutDashboard, BarChart3, CalendarDays, CalendarPlus, Scissors, Users, Settings, Camera, PawPrint } from 'lucide-react';
...
export const useAdminDashboard = () => {
  ...
  const icons = { overview: LayoutDashboard, 'new-booking': CalendarPlus, agenda: CalendarDays,
    ...
    pets: PawPrint, gallery: Camera, settings: Settings } as const;
