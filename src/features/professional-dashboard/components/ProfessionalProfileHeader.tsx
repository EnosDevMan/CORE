...
export const ProfessionalProfileHeader: React.FC<ProfessionalProfileHeaderProps> = ({
  activeProfessional,
  todayBookingsCount,
  pendingTodayCount,
  totalEarnings,
    ...
    <div className="core-workspace-banner bg-slate-900 text-white rounded-2xl p-6 sm:p-8 shadow-md mb-8 flex flex-col md:flex-row items-center justify-between gap-6">
      <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
        <div className="relative shrink-0">
          <img
            src={activeProfessional.avatar || DEFAULT_PROFESSIONAL_AVATAR}
        ...
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold font-sans mt-0.5">{activeProfessional.name}</h2>
          <p className="text-slate-300 text-xs sm:text-sm mt-1">{activeProfessional.specialty}</p>
          <button
            type="button"
            onClick={onEditProfile}
