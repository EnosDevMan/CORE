...
import { ProfessionalSelectionStep } from '../features/booking/components/ProfessionalSelectionStep';
...
export const BookingFlow: React.FC<BookingFlowProps> = ({ onSuccess, onNavigateToView, initialServiceId, initialProfessionalId }) => {
  const {
    step,
    services,
    professionals,
