...
if "from './pagedQuery';" not in text:
    text = text.replace(marker, marker + "\nimport { loadPagedRows, type PageResult } from './pagedQuery';", 1)
...
text = text.replace(' as unknown as PromiseLike<PageResult<BookingRow>>', ' as unknown as PromiseLike<PageResult<BookingRow>>')
text = text.replace(' as unknown as PromiseLike<PageResult<ProfileRow>>', ' as unknown as PromiseLike<PageResult<ProfileRow>>')
p.write_text(text)
