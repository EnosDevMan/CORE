...
7. **Em andamento (P2):** a suíte local não depende mais de credenciais Supabase para testar utilitários puros, artefatos locais estão ignorados e os contextos React foram separados dos componentes para manter Fast Refresh confiável. Ainda faltam paginação por tela, acessibilidade automatizada e budgets de bundle.
