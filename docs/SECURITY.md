...
- Links sociais são normalizados para HTTPS, restringidos ao provedor esperado
  e valores legados inseguros são descartados antes de chegar a um `href`.
- O deploy aplica CSP, HSTS, proteção contra framing e isolamento de origem;
  testes impedem a remoção acidental desses headers.
